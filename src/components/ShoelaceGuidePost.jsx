...
import {GET_SHOELACE_GUIDE_ID} from "../utilities/queries.js";
import {useQuery} from "@apollo/client";
import {Text} from "@chakra-ui/react";
import {RichText} from "@graphcms/rich-text-react-renderer";

export default function ShoelaceGuidePost() {
    const params = useParams();

    const {loading, error, data} = useQuery(
        GET_SHOELACE_GUIDE_ID, {
            variables: {
    ...
    return(
        <div>
            ...
            <RichText content={data.shoelaceGuide.guideContent.raw.children} />
        </div>
    );
}
